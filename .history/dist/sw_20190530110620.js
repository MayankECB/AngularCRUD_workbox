...
self.__precacheManifest = [
  ...
  {
    url: "index.html",
    revision: "50457a4391aa6a911b492b072353c4c0"
  },
  {
...
const addQueue = new workbox.backgroundSync.Queue("productOperationQueue", {
  onSync: async addQueue => {
    addQueue.replayRequests;
  }
});
...
workbox.routing.registerRoute(
  ...
  new workbox.strategies.NetworkOnly({
    plugins: [
      new workbox.backgroundSync.Plugin("productOperationQueue", {
